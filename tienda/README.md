# UTP TESIS | Materia de postgrado con opcion a graduacion

Comando para verificar la conexion del contenedor de la base de datos.
Se debio realizar unos cambios en nuestra reglas de hosts `/etc/hosts`, agregando el scope del localhost -> nombre del contenedor.
